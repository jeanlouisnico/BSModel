function surfacearea  = Areafunc(src, app)
...
%                     data.population(:,1) = yfitresult' ;
            ...
            data.populationToday        = str2double(app.SurfaceArea2013EditField.Value) ;
            data.population2030         = str2double(app.SurfaceArea2030EditField.Value) ;
            data.population2050         = str2double(app.SurfaceArea2050EditField.Value) ;
            data.PopulationSensitivity  = str2double(app.SensitivitySurfaceAreaEditField.Value) ;
            ...
            switch app.InterpolationmethodSurfaceAreaDropDown.Value
                case {'spline' 'linear'}
                    outputarray = lin_inter(x',y',app.InterpolationmethodSurfaceAreaDropDown.Value) ;
                    ...
                    outputarray = lin_inter(x_plusSens',y_plusSens',app.InterpolationmethodSurfaceAreaDropDown.Value) ;
                    ...
                    outputarray = lin_inter(x_minusSens',y_minusSens',app.InterpolationmethodSurfaceAreaDropDown.Value) ;
